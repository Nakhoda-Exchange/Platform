      ...
      <div className="flex w-full flex-col items-start gap-6">
        ...
        <div className="flex w-full flex-col gap-2 text-right">
          ...
          <p className="text-[15px] leading-[1.7] text-muted">
            برای معامله در ناخدا، طبق قوانین باید هویت شما تأیید شود؛ این کار از
            حساب و دارایی‌تان محافظت می‌کند.
          </p>
          <p className="text-[14px] leading-[1.7] text-muted">
            کد ملی و تاریخ تولد خود را وارد کنید. استعلام فوری انجام می‌شود و
            این اطلاعات فقط برای همین تأیید استفاده می‌شود.
          </p>
        </div>
      </div>
