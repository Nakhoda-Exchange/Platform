...
const ANNOUNCEMENTS: Announcement[] = [
  {
    ...
    body: "از امروز می‌توانید موجودی تومانی خود را با کارت‌به‌کارت شارژ کنید.\n\nاز صفحه «کیف پول» گزینه واریز را بزنید، کارت خود را انتخاب کنید و مبلغ را به شماره کارتی که نمایش داده می‌شود منتقل کنید. تأیید واریز به‌صورت خودکار انجام می‌شود.",
    at: ago(1),
  },
  {
    id: "new-memes",
