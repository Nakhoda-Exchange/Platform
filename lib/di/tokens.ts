...
import type { IncentiveLocksUseCase } from "@/lib/core/application/incentives/use-cases/incentive-locks.use-case";
...
export const TOKENS = {
  ...
  IncentiveLocksUseCase: token<IncentiveLocksUseCase>("IncentiveLocksUseCase"),
